...
> **Illustration:**
>
> ![Screenshot: Lambda Function Initialization Screen](images/5-Workshop/lambda.png)  
...
> **Illustration:**
>
> ![Screenshot: Accessing Execution Role from Lambda](images/5-Workshop/role.png)  
...
![Screenshot: Truy cập vào add policy từ Lambda](images/5-Workshop/permission.png)
---

# Step 4: Write the Lambda Function Code

Return to the Lambda Function interface and begin writing your Node.js code.
![Screenshot: Truy cập vào để viết code](images/5-Workshop/code.png)
